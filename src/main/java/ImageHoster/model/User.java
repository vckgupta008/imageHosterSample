...
public class User {
    ...
    // then all the records in 'users' table associated to that particular record in 'user_profile' table will be deleted or updated  first and
    // then the record in the 'user_profile' table will be deleted or updated
    //FetchType is EAGER
